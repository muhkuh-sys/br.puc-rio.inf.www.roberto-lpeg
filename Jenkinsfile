...
node {
    def ARTIFACTS_PATH = 'build/repository/br/puc-rio/inf/www/roberto/lpeg/*'
        ...
        stage("${atEntry[0]} ${atEntry[1]} ${atEntry[2]}"){
            docker.image("${atEntry[3]}").inside('-u root') {
                ...
                checkout([$class: 'GitSCM',
                    ...
                    submoduleCfg: [],
                    userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/br.puc-rio.inf.www.roberto-lpeg.git']]
                ])
